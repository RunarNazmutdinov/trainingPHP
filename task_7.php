                ...
                <div id="panel-1" class="panel">
                    ...
                    <div class="panel-container show">
                     ...
                     <?php 
                        ...
                        ?>
                        <div div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                           <?php foreach ($people as $person):?>  
                                ...
                                <div class=" <?php echo $person["status"] == "banned" ? "banned" : '' ?> rounded-pill  bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                    ...
                                    <div class="ml-2 mr-3">
                                        ...
                                        <a href="<?php echo $user["twitter_link_href"]?>" class="text-info fs-sm" target="_blank"><?php echo $user["twitter_link_text"]?></a> -
                                        <a href="<?php echo $user["email_link_href"]?>" class="text-info fs-sm" target="_blank" title="<?php echo $user["email_link_title"]?>"><?php echo $user["email_link_text"]?></a>
                                    </div>
                                </div>
                            <?php endforeach;?>
